...
class QAAgentConfig(Base):
    ...
    # QA Agent配置
    model_name = Column(String(100), nullable=False, default="gpt-5")
    temperature = Column(Float, nullable=False, default=0.7)
    max_tokens = Column(Integer, nullable=True, default=None)  # None表示无限制
    api_key = Column(Text, nullable=False, default="sk-p5AmVKF2bJhWseY2e5aYWMNOafbTmuykXCWteIKuUfYCcmWp")
    base_url = Column(String(200), nullable=False, default="https://linjinpeng-veloera.hf.space/v1")
...
class BrainstormAgentConfig(Base):
    ...
    # 模型A配置
    model_a_name = Column(String(100), nullable=False, default="gpt-5")
    model_a_temperature = Column(Float, nullable=False, default=0.7)
    model_a_api_key = Column(Text, nullable=False, default="sk-p5AmVKF2bJhWseY2e5aYWMNOafbTmuykXCWteIKuUfYCcmWp")
    model_a_base_url = Column(String(200), nullable=False, default="https://linjinpeng-veloera.hf.space/v1")
    model_a_system_prompt = Column(Text, nullable=True, default="你是一个智能的讨论参与者，擅长提供深入的分析和独特的见解。")

    # 模型B配置
    model_b_name = Column(String(100), nullable=False, default="gpt-5")
    model_b_temperature = Column(Float, nullable=False, default=0.7)
    model_b_api_key = Column(Text, nullable=False, default="sk-p5AmVKF2bJhWseY2e5aYWMNOafbTmuykXCWteIKuUfYCcmWp")
    model_b_base_url = Column(String(200), nullable=False, default="https://linjinpeng-veloera.hf.space/v1")
